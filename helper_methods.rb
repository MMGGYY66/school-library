...
module SaveData
  def check_file(filename)
    ...
    if !File.exist?('./data_files/people.json') && filename == 'people'
      FileUtils.touch('./data_files/people.json')
    end
    if !File.exist?('./data_files/rentals.json') && filename == 'rentals'
      FileUtils.touch('./data_files/rentals.json')
    end
